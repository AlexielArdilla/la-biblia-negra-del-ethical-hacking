...
Su tamaño, autonomía y conectividad lo convierten en una herramienta ideal para:
...
> ⚠ Todo lo aquí descrito es ilegal fuera de entornos de prueba controlados y con autorización expresa.
...
> ⚠ Todo lo descrito debe ejecutarse **únicamente** en redes privadas y con SIMs de laboratorio.
...
El MitM en redes móviles es una técnica de alto impacto que, en laboratorio, permite evaluar la verdadera exposición de usuarios frente a ataques avanzados.
Dominarlo es clave para diseñar defensas efectivas contra espionaje digital.
...
Modificar la syscall `getdents` para que no muestre procesos con nombre específico.
...
Esto lo hace extremadamente difícil de detectar con antivirus tradicionales que dependen de escaneo de archivos.
...
Un **keylogger** es un software o hardware diseñado para registrar las pulsaciones de teclado de un usuario.
...
> ⚠ Todo lo descrito aquí debe realizarse **únicamente** en entornos de laboratorio controlados.
...
Un **ataque a la cadena de suministro** busca comprometer un objetivo indirectamente, infiltrándose en alguno de los elementos, procesos o proveedores que intervienen antes de que el producto o servicio llegue al usuario final.
...
Los ataques a la cadena de suministro son de los más devastadores porque se infiltran en software o hardware antes de que llegue al usuario.
En laboratorio, reproducirlos ayuda a entender cómo detectarlos antes de que lleguen a producción.
...
La **exfiltración de datos encubierta** es el proceso de sacar información de un sistema comprometido evitando ser detectado por sistemas de seguridad como **DLP** (Data Loss Prevention), IDS/IPS o EDR.
...
El **hacking físico** es el conjunto de técnicas utilizadas para acceder a un entorno protegido comprometiendo las barreras físicas que lo resguardan.
En ciberseguridad ofensiva, a menudo es el **punto de entrada inicial** cuando las defensas digitales son fuertes pero la seguridad física es débil.
...
> ⚠ Todo lo que se describe aquí es únicamente para fines educativos y de pentesting autorizado.
...
**Ganzúas**: método tradicional para manipular pines internos.
Laboratorio:
...
La **ingeniería social** es el uso de la manipulación psicológica para influir en personas y lograr que revelen información o realicen acciones que comprometan la seguridad.
En operaciones ofensivas autorizadas, la ingeniería social es la herramienta más poderosa, porque la debilidad más común no está en el software, sino en **el factor humano**.
...
* Plantillas que imitan al 100% la interfaz de servicios legítimos.
...
Cuerpo: Estimado Sr. Pérez, detectamos un error en el pago del proveedor X. Necesitamos que acceda al portal para confirmar la información:
[Enlace malicioso]
```
...
**OSINT** (Open Source Intelligence) es la recopilación y análisis de información pública para generar inteligencia accionable.
En un pentest o en una operación ofensiva real, el OSINT sirve para:
...
Aplicar cualquiera de las técnicas explicadas en sistemas o redes que no sean de tu propiedad, o sin el consentimiento explícito del propietario, es **ILEGAL** en la mayoría de países y puede resultar en:
...
Cada exploit que aprendas debe ir acompañado de una pregunta:
...
💡 **TIP Final Black-Hat Ético:**
Un hacker sin ética es un delincuente.
Un hacker con ética es un escudo invisible que protege en silencio.
...
**ser un guardián anónimo, un centinela que nunca duerme.**

---

**Dedicatoria Final:**
A todos los que creen que el conocimiento es un arma y, aun así, deciden usarlo como un escudo.
A los que protegen sin que nadie lo sepa.
A quienes eligen ser parte de la solución, aunque sea más tentador ser parte del problema.

---

💡 **Reflexión final:**
El día que uses todo lo aprendido para salvar a alguien de un desastre digital, entenderás que este libro no era un manual de ataque, sino un juramento silencioso de defensa.
